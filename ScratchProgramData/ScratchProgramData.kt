...
class ScratchProgramData : Serializable, Parcelable {
    ...
    fun addRemixProgram(remixProgramData: ScratchProgramData) = remixes.add(remixProgramData)
    fun getTags(): List<String> = tags
    fun addTag(tagName: String) = tags.add(tagName)
    fun getRemixes(): List<ScratchProgramData> = remixes
    ...
    companion object {
        ...
        @JvmField
        val CREATOR: Parcelable.Creator<ScratchProgramData?> =
            object : Parcelable.Creator<ScratchProgramData?> {
                override fun createFromParcel(source: Parcel): ScratchProgramData? = ScratchProgramData(source)
                override fun newArray(size: Int): Array<ScratchProgramData?> = arrayOfNulls(size)
            }
    }
}
